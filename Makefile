...
SRC = main.c draw_tools.c win_draw.c win_init.c win_handlers.c parse.c sphere.c plane.c vector.c vector2.c source.c color.c color2.c util.c cylinder.c cone.c matrix.c obj_type.c illumination.c
ifeq ($(OS), Darwin)
    MLX = 
	I_MLX = 
